...
logger = setup_logger(name=__name__, log_file=Path("logs/sent_mail.log"))
...
async def save_sent_mail(start_date: str, end_date: str, keyword: str):
    """メール受信を実行する関数"""
    setting = Settings()
    ...
    try:
        ...
        await client.save_sent_mailbox(start_date=start, end_date=end, keyword=keyword)
...
if __name__ == "__main__":
    ...
    asyncio.run(save_sent_mail(start_datetime, end_datetime, "test"))
